...
> v1.0.0版本**minSdkVersion**为**19**，v1.1.x版本**minSdkVersion**调整为**21**，为长期维护版本，详见分支[master](https://github.com/shenbengit/MVVMKit)； 
```gradle
plugins {
    ...
    id 'kotlin-kapt'
...
dependencies {
    implementation 'com.github.shenbengit:MVVMKit:1.0.8'
}
```
