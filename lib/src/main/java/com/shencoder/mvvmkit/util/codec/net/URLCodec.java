...
package com.shencoder.mvvmkit.util.codec.net;

import com.shencoder.mvvmkit.util.codec.BinaryDecoder;
import com.shencoder.mvvmkit.util.codec.BinaryEncoder;
import com.shencoder.mvvmkit.util.codec.CharEncoding;
import com.shencoder.mvvmkit.util.codec.DecoderException;
import com.shencoder.mvvmkit.util.codec.EncoderException;
import com.shencoder.mvvmkit.util.codec.StringDecoder;
import com.shencoder.mvvmkit.util.codec.StringEncoder;
import com.shencoder.mvvmkit.util.codec.binary.StringUtils;
...
public class URLCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
     ...
     */
    public static byte[] decodeUrl(final byte[] bytes) throws DecoderException {
        if (bytes == null) {
            return null;
        }
